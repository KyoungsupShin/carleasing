...
start cmd /k "python ./apis.py --port 8503 --excel ../data/dgb.xlsx"

start cmd /k "python ./apis.py --port 8504 --excel ../data/dgb.xlsx"
...
start cmd /k "python ./apis.py --port 8513 --excel ../data_detail/dgb.xlsx"

start cmd /k "python ./apis.py --port 8514 --excel ../data_detail/dgb.xlsx"
